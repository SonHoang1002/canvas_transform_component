...
class ComponentTransform extends Equatable {
  ...
  ({Offset bl, Offset br, Offset tl, Offset tr}) get rotatedEdges =>
      rotateRect(rect, angle, pos + Offset(size.width / 2, size.height / 2));

  ({Offset bl, Offset br, Offset tl, Offset tr}) get edges =>
      rotateRect(rect, angle, pos);
