                ...
                children: [
                  ...
                  _InputItem(
                    ...
                    prefix: Transform.translate(
                      ...
                      child: const Icon(Icons.rounded_corner_rounded, size: 12),
                    ),
                    keyboardType: TextInputType.number,
              ...
              children: [
                ...
                Expanded(
                  child: TextField(
                    maxLength: 6,
                    onChanged:
                        (value) => context.canvasCubit.update(
      ...
      (
        children: [
          ...
          (
            ...
            onChanged:
                (String text) => context.canvasCubit.update(
                  backgroundSize: Size(
                ...
                contents: [
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...controls!.indexed.map((ele) {
                          var i = ele.$1;
                          var outerContent = ele.$2;
                          return Padding(
                            ...
                            child: SizedBox(
                              ...
                              child: ToggleButtons(
                                ...
                                children: [
                                  ...outerContent.children.indexed.map(
                                    (ele) {
                                      var index = ele.$1;
                                      var innerContent = ele.$2;
                                      return Padding(
                                      padding:
                                          index == 0
...
class _InputGroup {
  const _InputGroup({required this.children, this.isSelected, this.onPressed});
